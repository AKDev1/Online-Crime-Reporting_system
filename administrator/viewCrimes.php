...
?>
  <div class="container">
    <div id="header">
        ...
        <div class="div2">
           <div class="logo"><img src="../images/india.png" width="70px"/>Crime Reporting System</div> <h3>| Admin Panel</h3>
        </div>
    </div>
    ...
    <div class="main">
        <div class="heading">
            <h1><img src="images/home.png" style="position: relative; " />&nbsp; Crimes</h1>
            <div class="clear"></div>
        </div>
        <div class="content">
          <div class="row">
          ...
          <tr>
              <td colspan="2">
              <span><iframe width="100%" name="iframe_crime"></iframe></span>
            </td>
          </tr>
						<tr>
                      	<td colspan="2">
